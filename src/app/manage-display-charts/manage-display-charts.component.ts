...
export class ManageDisplayChartsComponent implements OnInit {
  ...
  @Input() configChart = new classchartHealth; // default values
  @Input() inFileParamChart = new classFileParamChart; // user specific values
  @Input() configServer = new configServer;

  // files to manage
  @Input() HealthAllData = new mainDailyReport;
  @Input() perfTotalCircuit:Array<any>=[];
  @Input() perfCircuit:Array<any>=[];
  
  @Input() typeChartToDisplay:string=""; // Health, Sport
  getFileOnly:boolean=false;
  ...
  @Input() theActions ={manageParam:false, displayCanvas:false};
  ...
  ngAfterViewInit() { // this.configChart.barChart.length     
  ...
  ngOnInit() {
    ...
    for (i = 0; i < this.configChart.barDefault.datasets.labels.length; i++) {
    ...
    for (i = 0; i < this.configChart.barDefault.datasets.labelsLimits.length; i++) {

      this.FillSelected.selected = 'N';
      this.ListChart.push(this.FormChart());
      this.ListChart.controls[i + this.configChart.barDefault.datasets.labels.length - 1].setValue(this.FillSelected);
    ...
    for (i = 0; i < this.configChart.chartTypes.length; i++) {
      this.lineChartType[i] = this.configChart.chartTypes[i];
    }
    ...
    if (this.inFileParamChart.fileType !== undefined && this.inFileParamChart.fileType !== '') {
      for (i = 0; i < 4; i++) {
        ...
        if (this.tabParamChart[i].labels.length === 0) {
          for (var k = 0; k < this.configChart.barDefault.datasets.fieldsToSelect.length; k++) {
            if (this.configChart.barDefault.datasets.fieldsToSelect[k] === false) {
        ...
        for (var j = 0; j < this.tabParamChart[i].labelsColor.length; j++) {
          if (this.tabParamChart[i].labelsColor[j] === undefined || this.tabParamChart[i].labelsColor[j] === "") {
            this.tabParamChart[i].labelsColor[j] = this.configChart.barDefault.datasets.borderColor[j];
          }
        }
      ...
      for (i = 0; i < 4; i++) {
        ...
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.display = this.configChart.barDefault.options.plugins.title.display;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.text = this.configChart.barDefault.options.plugins.title.text;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.position = this.configChart.barDefault.options.plugins.title.position;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.padding.top = this.configChart.barDefault.options.plugins.title.padding.top;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.padding.bottom = this.configChart.barDefault.options.plugins.title.padding.bottom;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.align = this.configChart.barDefault.options.plugins.title.align;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.color = this.configChart.barDefault.options.plugins.title.color;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.font.size = this.configChart.barDefault.options.plugins.title.font.size;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.font.weight = this.configChart.barDefault.options.plugins.title.font.weight;
        this.tabParamChart[this.tabParamChart.length - 1].chartTitle.font.family = this.configChart.barDefault.options.plugins.title.font.family;

        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.display = this.configChart.barDefault.options.plugins.legend.title.display;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.text = this.configChart.barDefault.options.plugins.legend.title.text;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.position = this.configChart.barDefault.options.plugins.legend.title.position;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.padding.top = this.configChart.barDefault.options.plugins.legend.title.padding.top;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.padding.bottom = this.configChart.barDefault.options.plugins.legend.title.padding.bottom;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.padding.left = this.configChart.barDefault.options.plugins.legend.title.padding.left;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.align = this.configChart.barDefault.options.plugins.legend.title.align;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.color = this.configChart.barDefault.options.plugins.legend.title.color;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.font.size = this.configChart.barDefault.options.plugins.legend.title.font.size;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.font.weight = this.configChart.barDefault.options.plugins.legend.title.font.weight;
        this.tabParamChart[this.tabParamChart.length - 1].legendTitle.font.family = this.configChart.barDefault.options.plugins.legend.title.font.family;

        this.tabParamChart[this.tabParamChart.length - 1].legendBox.boxWidth = this.configChart.barDefault.options.plugins.legend.labels.boxWidth;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.boxHeight = this.configChart.barDefault.options.plugins.legend.labels.boxHeight;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.usePointStyle = this.configChart.barDefault.options.plugins.legend.labels.usePointStyle;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.pointStyle = this.configChart.barDefault.options.plugins.legend.labels.pointStyle;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.borderRadius = this.configChart.barDefault.options.plugins.legend.labels.borderRadius;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.color = this.configChart.barDefault.options.plugins.legend.labels.color;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.font.size = this.configChart.barDefault.options.plugins.legend.labels.font.size;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.font.weight = this.configChart.barDefault.options.plugins.legend.labels.font.weight;
        this.tabParamChart[this.tabParamChart.length - 1].legendBox.font.family = this.configChart.barDefault.options.plugins.legend.labels.font.family;

        this.tabParamChart[this.tabParamChart.length - 1].bar = this.configChart.barChart.datasets;
        this.tabParamChart[this.tabParamChart.length - 1].line = this.configChart.lineChart.datasetsDefault;

        this.tabParamChart[this.tabParamChart.length - 1].canvasBackground = this.configChart.barDefault.canvas.backgroundcolor;
        this.tabParamChart[this.tabParamChart.length - 1].canvasHeight = this.configChart.barDefault.canvas.height
        this.tabParamChart[this.tabParamChart.length - 1].canvasMarginLeft = this.configChart.barDefault.canvas.marginleft;
        this.tabParamChart[this.tabParamChart.length - 1].canvasWidth = this.configChart.barDefault.canvas.width;


        for (var l = 0; l < this.configChart.barDefault.datasets.labelsLimits.length; l++) {
          if (this.configChart.barDefault.datasets.fieldsLimitsToSelect[l] === true) {
          ...
          this.tabParamChart[this.tabParamChart.length - 1].limitLabelsColor[l] = this.configChart.barDefault.datasets.borderColorLimits[l];
        }

        for (var l = 0; l < this.configChart.barDefault.datasets.fieldsToSelect.length; l++) {
          if (this.configChart.barDefault.datasets.fieldsToSelect[l] === true) {
          ...
          this.tabParamChart[this.tabParamChart.length - 1].labelsColor[l] = this.configChart.barDefault.datasets.borderColor[l];
          if (l > 0) {
            const myRgba = { slider: new classReturnColor, palette: new classReturnColor }
        ...
        this.tabParamChart[this.tabParamChart.length - 1].axisX.border.color = this.configChart.barDefault.options.scales.axisX.border.color;
        this.tabParamChart[this.tabParamChart.length - 1].axisX.border.width = this.configChart.barDefault.options.scales.axisX.border.width;
        this.tabParamChart[this.tabParamChart.length - 1].axisX.position = this.configChart.barDefault.options.scales.axisX.position;
        this.tabParamChart[this.tabParamChart.length - 1].axisX.stacked = this.configChart.barDefault.options.scales.axisX.stacked;
        this.tabParamChart[this.tabParamChart.length - 1].axisX.ticks = this.configChart.barDefault.options.scales.axisX.ticks;

        this.tabParamChart[this.tabParamChart.length - 1].axisY.border.color = this.configChart.barDefault.options.scales.axisY.border.color;
        this.tabParamChart[this.tabParamChart.length - 1].axisY.border.width = this.configChart.barDefault.options.scales.axisY.border.width;
        this.tabParamChart[this.tabParamChart.length - 1].axisY.position = this.configChart.barDefault.options.scales.axisY.position;
        this.tabParamChart[this.tabParamChart.length - 1].axisY.stacked = this.configChart.barDefault.options.scales.axisY.stacked;
        this.tabParamChart[this.tabParamChart.length - 1].axisY.ticks = this.configChart.barDefault.options.scales.axisY.ticks;
  ...
  ngOnChanges(changes: SimpleChanges) {
    for (const propName in changes) {
      ...
      if (propName === 'typeChartToDisplay' && changes[propName].firstChange === true) {
          ...
          this.getFileOnly = true;
          this.iWaitToRetrieve[0]=0;
          if (this.typeChartToDisplay === 'Health' && this.HealthAllData.tabDailyReport.length===0){
            this.iWaitToRetrieve[1]=0;
          } else if (this.typeChartToDisplay === 'Sport' && this.perfCircuit.length===0){
            this.iWaitToRetrieve[1]=7;
          } 
      }  else
        if (propName === 'HealthAllData' && changes[propName].firstChange === false) {

      } else
        if (propName === 'inFileParamChart' && changes[propName].firstChange === false) {

      } else
        if (propName === 'perfTotalCircuit' && changes[propName].firstChange === false) {

      } else
        if (propName === 'perfCircuit' && changes[propName].firstChange === false) {
  ...
  fillInFormFromTab(nb: number) {
    ...
    if (this.tabParamChart[nb].nbWeeks!==undefined){
      ...
      this.selectChart.controls['nbWeeks'].setValue(0);
    }
    ...
    if (this.tabLock.lock !== 2) {
      ...
      if (event.target.id === 'submit') {
        ...
        if (this.selectedLimitFields[item] === 'Y') {
          this.FillSelected.selected = 'N';
          this.ListChart.controls[item + this.configChart.barDefault.datasets.labels.length - 1].setValue(this.FillSelected);
  ...
  collectSpecialData(nb: number, datasetsSpecialBar: Array<any>, dateLabelSpecial: Array<any>, datasetsLimit: Array<any>, dateLabelLimit: Array<any>) {
    ...
    const returnData = fillHealthDataSet(dateLabelSpecial, datasetsSpecialBar, this.HealthAllData,this.tabParamChart[nb], this.configChart, addWeekly, this.identification);
    ...
    const newChart=specialDraw(this.tabCtx[nb],this.tabParamChart[nb], this.configChart, dateLabelSpecial, datasetsSpecialBar);
  ...
  testLineChart() {
    ...
    this.myNewTabChart = new Chart(
      ...
      data: {
        ...
        datasets: [{
          label: 'll1', data: [2, 3, 4, 5, 6, 2, 3, 4, 15], borderColor: ['blue', 'red', 'green', 'yellow', 'lightred', 'pink', 'orange', 'lightblue'],
